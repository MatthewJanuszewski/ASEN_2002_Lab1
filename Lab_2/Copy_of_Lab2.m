...
% xlabel('Input Voltage (V)');
% ylabel('Resulting Airspeed (m/s)');
% title('Airspeed for Venturi Probe');

figure 
hold on
errorbar(voltV,airSpdV,EV,'b','LineWidth',2)
errorbar(voltP,airSpdP,EP,'r','LineWidth',2)
xlabel('Input Voltage (V)')
ylabel('Velocity (m/s)')
title('Airspeed Readings')
legend('Venturi Tube','Pitot-Static Tube')
hold off
